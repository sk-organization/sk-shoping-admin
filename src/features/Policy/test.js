<div>
    <h1 style={{ textAlign: 'center', fontSize: 30 }}>Pri</h1>
    <div>
      ...
      <p>
        skshopping.com ("us", "we", or "our") operates the skshopping.com mobile
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for skshopping.com is
      ...
      <p>skshopping.com uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        skshopping.com will take all steps reasonably necessary to ensure that
      ...
      <p>
        skshopping.com may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of skshopping.com</li>
        <li>
      ...
      <ul>
        <li>By email: designersalman0786@gmail.com</li>
      </ul>
    </div>